  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, rgba(168, 85, 247, 0.03), transparent 60%)',
        bottom: '-10%', left: '-5%',
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, rgba(16, 185, 129, 0.025), transparent 60%)',
        top: '60%', right: '20%',
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} className="glass-card" style={{ padding: 32 }}>
          ...
          <div style={{ textAlign: 'right', marginBottom: 22 }}>
            <Link to="/reset-password" style={{ fontSize: 'var(--font-size-sm)', color: 'var(--color-accent)', fontWeight: 500 }}>
              Forgot password?
            </Link>
          </div>
          ...
          <div style={{ textAlign: 'center', marginTop: 22, fontSize: 'var(--font-size-sm)', color: 'var(--color-text-muted)' }}>
            Don't have an account?{' '}
            <Link to="/signup" style={{ color: 'var(--color-accent)', fontWeight: 600 }}>Sign up</Link>
          </div>
        </form>
      </div>
    </div>
